...
class Window:
    ...
    # # Navigation Methods
    # Press Tab To Next Field for Text Widget
    def next_widget_to_address(self, event):
        event.widget.tk_focusNext().focus()
        return ('break')
    
    # # Create Widget Area
    # Create Menubar Except File Menu Widget
    def create_other_menu_bars(self):
        # Adding Items
    ...
    def create_party_widget(self):
        ...
        if self.selected_party:
            Button(self.base_Frame, text="Delete", font=15, command=self.delete_party).grid(row=9, column=2,
                                                                                            padx=20,
                                                                                            pady=20)
    ...
    def edit_voucher_widget(self):
        ...
        # Tree View Heading Lablel
        Label(heading, text="Edit Voucher", font=("Arial", 25), bg='light blue').pack(expand=True, fill=BOTH,
                                                                                      side=BOTTOM)
        # Tree View Frame
        controls_frame = Frame(self.base_Frame, relief=RAISED, bd=5, bg='light blue')
        controls_frame.place(relx=0, rely=0.1, relwidth=1, relheight=0.1)
    ...
    # Delete Ledger If No Other Data Attached with It
    ...
    # Delete Party If No Bill Attached with It
